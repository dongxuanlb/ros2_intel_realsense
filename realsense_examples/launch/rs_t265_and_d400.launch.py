...
def generate_launch_description():
    ...
    t265_serial_no = LaunchConfiguration('serial_no', default='905312110278')

    rgbd_base_frame_id = LaunchConfiguration('base_frame_id', default='d435_link')
    rgbd_serial_no = LaunchConfiguration('serial_no', default='837212070949')
    ...
    rgbd_node = Node(
        ...
        parameters=[{'serial_no':rgbd_serial_no, 
                'base_frame_id': rgbd_base_frame_id, 'delay': 3}]
        )
